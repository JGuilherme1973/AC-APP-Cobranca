...
export default function AppLayout({ children }: AppLayoutProps) {
  ...
  return (
    <div className="flex h-screen overflow-hidden" style={{ backgroundColor: '#F6F2EC' }}>
      ...
      {/* ââ Overlay mobile âââââââââââââââââââââââââââââââââââ */}
      {mobileOpen && (
        <div
      ...
      {/* ââ Ãrea principal âââââââââââââââââââââââââââââââââââ */}
